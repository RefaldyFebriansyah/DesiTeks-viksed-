...
<div class="dt-page-header">
    <div>
        <h1 class="dt-page-title">Tambah Supplier</h1>
...
<div class="dt-card col-md-6">
    <form method="POST" action="{{ route('admin.suppliers.store') }}">
        ...
        <div class="dt-form-group">
            ...
            <input type="text" name="no_telepon" class="dt-input" value="{{ old('no_telepon') }}" placeholder="Contoh: 08123456789">
        </div>
        <div class="dt-form-group">
            <label class="dt-label">Alamat</label>
            <textarea name="alamat" class="dt-textarea" placeholder="Alamat lengkap supplier...">{{ old('alamat') }}</textarea>
        </div>
