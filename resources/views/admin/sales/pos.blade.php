            ...
            <div class="dt-cart-footer">
                ...
                <form id="saleForm" method="POST" action="{{ route($storeRoute) }}" onsubmit="return validateSale()">
                    ...
                    <div class="dt-form-group mb-2">
                        ...
                        <input type="number" id="jumlahBayar" name="jumlah_bayar" class="dt-input" style="font-size:15px;font-weight:600"
                               placeholder="0" min="0" step="1000" oninput="hitungKembalian()">
                    </div>
