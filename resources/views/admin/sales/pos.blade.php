...
<iframe id="printReceiptFrame" src="{{ route('admin.sales.receipt', session('auto_print_sale_id')) }}" style="display:none;"></iframe>
<script>
document.addEventListener('DOMContentLoaded', function() {
        ...
        iframe.onload = function() {
            setTimeout(function() {
                try {
                    ...
                    window.open("{{ route('admin.sales.receipt', session('auto_print_sale_id')) }}", "_blank");
                }
            }, 300);
        };
    }
