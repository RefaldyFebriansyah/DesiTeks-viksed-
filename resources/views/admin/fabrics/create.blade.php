        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="dt-form-group">
                    ...
                    <input type="number" step="0.01" name="meter_per_rol" class="dt-input @error('meter_per_rol') is-invalid @enderror" value="{{ old('meter_per_rol', 50.00) }}" required>
            ...
            <div class="col-md-6">
                <div class="dt-form-group">
                    ...
                    <input type="number" name="stok_maksimum" class="dt-input @error('stok_maksimum') is-invalid @enderror" value="{{ old('stok_maksimum', 25) }}" placeholder="Contoh: 25">
