...
<div class="dt-page-header">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <button type="button" class="dt-btn dt-btn-primary dt-btn-sm d-inline-flex align-items-center gap-1.5" data-bs-toggle="modal" data-bs-target="#suratJalanModalAdmin">
...
<div class="dt-card mb-3 p-0 overflow-hidden">
    <div class="row g-0 border-bottom">
        ...
        <div class="col-12 col-md-4 p-3 p-md-4">
            ...
            @if($incomingGood->foto_lampiran)
            <div class="mt-2">
                <button type="button" class="dt-btn dt-btn-gold dt-btn-xs w-100 w-md-auto" data-bs-toggle="modal" data-bs-target="#suratJalanModalAdmin">
