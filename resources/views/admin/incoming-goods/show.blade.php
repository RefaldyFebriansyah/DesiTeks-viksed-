...
<div class="dt-card mb-3" style="padding: 0; overflow: hidden;">
    ...
    <div style="display:flex; background: #f8fafc;">
        ...
        <div style="flex:1; padding:14px 24px; text-align:center;">
            <div style="font-size:11px; color:var(--dt-muted); font-weight:600; text-transform:uppercase; letter-spacing:.8px;">Total Pembelian</div>
            <div style="font-size:22px; font-weight:700; color:var(--dt-success); margin-top:2px;">Rp {{ number_format($incomingGood->total_pembelian, 0, ',', '.') }}</div>
            <div style="font-size:11px; color:var(--dt-muted);">nilai pembelian</div>
        </div>
    </div>
</div>
        ...
        <table class="dt-table">
            ...
            <tfoot>
                <tr style="background:#f8fafc; border-top: 2px solid var(--dt-border);">
                    ...
                    <td></td>
                    <td class="text-end fw-700" style="font-size:15px; color:var(--dt-success); padding: 12px 16px;">
                        Rp {{ number_format($incomingGood->total_pembelian, 0, ',', '.') }}
                    </td>
                </tr>
            </tfoot>
        </table>
