...
<div class="dt-card">
    <form method="POST" action="{{ route('admin.incoming-goods.store') }}" id="incomingForm">
        @csrf
                            ...
                            <div class="p-2 border rounded bg-light mb-2">
                                <div class="row g-2 align-items-center mb-2">
                                    ...
                                    <div class="col-md-4 text-end mt-4">
                                        <button type="button" class="dt-btn dt-btn-danger dt-btn-xs" onclick="removeItemRow(0)">Hapus Baris</button>
                                    </div>
                                </div>
                                ...
                                <div id="new_fabric_fields_0" class="row g-2 mt-2 pt-2 border-top" style="display:none;">
                                    <div class="col-12"><small class="fw-600 text-navy">Informasi Kain Baru:</small></div>
                                    <div class="col-md-4">
        ...
        <td colspan="5">
            <div class="p-2 border rounded bg-light mb-2">
                <div class="row g-2 align-items-center mb-2">
                    ...
                    <div class="col-md-4 text-end mt-4">
                        <button type="button" class="dt-btn dt-btn-danger dt-btn-xs" onclick="removeItemRow(${idx})">Hapus Baris</button>
                    </div>
                </div>
