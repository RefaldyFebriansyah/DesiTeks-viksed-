...
@section('page-title', 'Edit Data Supplier (Gudang)')
    ...
    <div class="col-12 col-md-10 col-lg-8 col-xl-7">
        <div class="dt-page-header mb-4">
            <div>
                ...
                <div class="dt-breadcrumb">Gudang / Supplier / Edit</div>
            </div>
        ...
        <div class="dt-card border-0 shadow-sm" style="border-radius: 16px; overflow: hidden;">
            ...
            <div class="p-4 bg-white">
                <form method="POST" action="{{ route('gudang.suppliers.update', $supplier) }}">
                    @csrf
                    @method('PUT')
