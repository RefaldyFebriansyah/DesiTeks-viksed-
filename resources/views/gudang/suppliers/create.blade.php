        ...
        <div class="dt-card border-0 shadow-sm" style="border-radius: 16px; overflow: hidden;">
            <div class="p-4 border-bottom bg-light bg-opacity-60">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="fw-bold text-navy mb-0" style="font-size: 16px;">Formulir Supplier Baru</h5>
                        <p class="text-muted mb-0" style="font-size: 12.5px;">Isi kelengkapan data supplier kain di bawah ini</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-white">
                <form method="POST" action="{{ route('gudang.suppliers.store') }}">
                    ...
                    <div class="dt-form-group mb-3">
                        ...
                        <input type="text" name="nama_supplier" class="form-control form-control-lg @error('nama_supplier') is-invalid @enderror" value="{{ old('nama_supplier') }}" required placeholder="Contoh: PT. Tekstil Nusantara" style="font-size: 14px;">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <div class="dt-form-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="supplier@pabrik.com" style="font-size: 13.5px;">
                        ...
                        <div class="col-md-6">
                            <div class="dt-form-group">
                                ...
                                <input type="text" name="asal_kota" class="form-control @error('asal_kota') is-invalid @enderror" value="{{ old('asal_kota') }}" placeholder="Contoh: Bandung / Jakarta" style="font-size: 13.5px;">
                    ...
                    <div class="dt-form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="no_telepon" class="form-control border-start-0 @error('no_telepon') is-invalid @enderror" value="{{ old('no_telepon') }}" placeholder="81234567890" style="font-size: 13.5px;">
                        </div>
                    ...
                    <div class="dt-form-group mb-4">
                        ...
                        <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat pabrik / gudang supplier..." style="font-size: 13.5px;">{{ old('alamat') }}</textarea>
                        @error('alamat') <div class="dt-error-msg mt-1">{{ $message }}</div> @enderror
                    </div>

                    <div class="pt-3 border-top d-flex align-items-center justify-content-between">
                        <a href="{{ route('gudang.suppliers.index') }}" class="dt-btn dt-btn-outline px-4">Batal</a>
                        <button type="submit" class="dt-btn dt-btn-primary px-4"><i class="bi bi-check-lg me-1"></i> Simpan Supplier</button>
                    </div>
                </form>
            </div>
        </div>
